<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="EditCustomerInfo.aspx.cs" Inherits="FertilizerManagementSystem.CustomerPayment" %>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    <h4>तुमचे प्रोफाइल</h4>
                                    <span>खाते स्थिती - </span>
                                    <asp:Label class="badge badge-pill badge-info" ID="Label1" runat="server" Text="तुमच्या खात्याची स्थिती"></asp:Label>
                                </center>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ErrorMessage="पूर्ण नाव टाका" ControlToValidate="txtFullName" ValidationGroup="SignValidationGroup"> </asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="txtContact" runat="server" placeholder="संपर्क क्रमांक" TextMode="Number"></asp:TextBox>
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ErrorMessage="अवैध संपर्क क्रमांक" ControlToValidate="txtContact" ValidationGroup="SignUpValidationGroup" ValidationExpression="^[789]\d{9}$"></asp:RegularExpressionValidator>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="अवैध ईमेल" ControlToValidate="txtEmail" ValidationGroup="SignUpValidationGroup" ValidationExpression="^([a-zA-Z0-9]([a-zA-Z0-9.]+)?[a-zA-Z0-9])@([a-zA-Z0-9]([a-zA-Z0-9\-]+)?[a-zA-Z0-9])\.([a-zA-Z]{2,})(\.[a-zA-Z]{2,})?$"></asp:RegularExpressionValidator>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox class="form-control" ID="txtUsername" runat="server" placeholder="वापरकर्तानाव" ReadOnly="True"></asp:TextBox>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox class="form-control" ID="txtOldPassword" runat="server" placeholder="जुना पासवर्ड" ReadOnly="True"></asp:TextBox>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox class="form-control" ID="txtNewPassword" runat="server" placeholder="नवीन पासवर्ड" TextMode="Password"></asp:TextBox>
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="पासवर्ड किमान 8 वर्णांचा असावा, त्यात किमान एक अप्परकेस अक्षर, एक लोअरकेस अक्षर, एक अंक आणि एक विशेष वर्ण असावा." ControlToValidate="txtNewPassword" ValidationExpression="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[!@#$%^&*()_+])[A-Za-z\d!@#$%^&*()_+]{8,}$
" ValidationGroup="SignUpValidationGroup"></asp:RegularExpressionValidator>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-8 mx-auto">
                                <center>
                                    <div class="form-group">
                                        <asp:Button class="btn btn-primary btn-block btn-lg" ID="btnUpdate" runat="server" Text="अपडेट करा" OnClick="btnUpdate_Click" ValidationGroup="SignUpValidationGroup" />
                                    </div>
                                </center>
                            </div>
                        </div>
