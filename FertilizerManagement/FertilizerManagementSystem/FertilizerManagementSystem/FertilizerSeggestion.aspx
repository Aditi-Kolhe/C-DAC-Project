            ...
            <div class="col-md-7 mx-auto">
                <div class="card">
                    <div class="card-body">
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowDataBound="GridView1_RowDataBound" CellPadding="2" ForeColor="Black" GridLines="None" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px">
                            ...
                            <Columns>
                               ...
                               <%-- <asp:ImageField DataImageUrlField="image" HeaderText="प्रातिबंब">
