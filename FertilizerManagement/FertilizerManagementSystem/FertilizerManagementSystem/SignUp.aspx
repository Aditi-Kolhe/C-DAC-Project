                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img src="iImages/sign-up.png" width="100px" />
                                </center>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="अवैध ईमेल" ControlToValidate="txtEmail" ValidationGroup="SignUpValidationGroup" ValidationExpression="^([a-z0-9]([a-z0-9.]+)?[a-z0-9])@([a-z0-9]([a-z0-9\-]+)?[a-z0-9])\.([a-z]{2,})(\.[a-z]{2,})?$"></asp:RegularExpressionValidator>
                                </div>
                            </div>
                        </div>
                        <div class="row">
