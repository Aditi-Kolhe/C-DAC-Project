                ...
                <div class="card">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <asp:TextBox CssClass="form-control" ID="txtRemainingAmount" runat="server" placeholder="Remaining Amount" ReadOnly="true"></asp:TextBox>

                                        <%--<asp:Button ID="btnUpdateAccountStatus" runat="server" Text="Update" class="btn btn-info" OnClick="btnUpdateAccountStatus_Click" ValidationGroup="CustMangementValidationGroup" />--%>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-8 mx-auto">
                            <asp:Button ID="BtnUpdateUser" class="btn btn-lg btn-block btn-success" runat="server" Text="Update" OnClick="btnUpdateAccountStatus_Click" />
                        </div>
                    </div>
                    <br />
                    <br>
